package com.yyty.hao.studyproject.pattern;


import com.yyty.hao.studyproject.Impl.DynamicProxy;
import com.yyty.hao.studyproject.business.XiaoMing;
...
public class ProxyPattern implements IPattern {
    ...
    public void show() {
        ...
        ILawsuit layer = (ILawsuit) Proxy.newProxyInstance(classLoader, new Class[]{ILawsuit.class}, proxy);
        layer.submit();
        layer.burden();
        layer.defend();
        layer.finish();
